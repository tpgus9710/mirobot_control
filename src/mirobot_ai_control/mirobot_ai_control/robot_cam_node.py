...
# 실제 장착 기준(2026-09-04): cam1 이 팔에, cam0 이 베이스(주행 시야)에 달렸다.
# 처음에는 반대로 적어 두었는데 장착이 그 반대여서 바로잡았다.
# 카메라를 옮겨 달면 여기만 고치면 된다 — 없는 번호를 적으면
# _resolve_cam_map 이 있는 카메라로 대체하고 경고를 남긴다.
CAM_FOR_MODE = {'arm': 1, 'base': 0}
DEFAULT_MODE = 'arm'
